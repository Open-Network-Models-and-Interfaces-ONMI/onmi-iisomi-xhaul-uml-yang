...
public class DemoAppProvider implements MountpointChangeListener, BindingAwareProvider, AutoCloseable {

    private static final Logger LOG = LoggerFactory.getLogger(DemoAppProvider.class);
    ...
    public void onSessionInitiated(ProviderContext pSession) {
        ...
        LOG.info("DemoAppProvider Session Initiated");
        demoappService = new DemoAppServiceImpl(pSession);
    ...
    public void close() throws Exception {
        LOG.info("DemoAppProvider Closed");
        if (demoappService != null) {
