...
function executeGetSet(url, leafData, chainType) {
    ...
    if (res != "") {
        ...
        debug.write("Automated Set Operation: Set Operation has been carried out for URL " + finalUrl, true, fs.openSync(TestResultFile, "a+"));
        ...
        if (res1 != "") {
            ...
            debug.write("Automated Reset Operation: Reverting the values changed by Set Operation to original values", true, fs.openSync(TestResultFile, "a+"));
