#!/bin/bash
# 
# Scripts for ONF PoC4.1 to create a MWTN specific TAR file containing ODL Karaf Boron container and MWTN specific applications
# Refering to README2CreateTarBundle.md
