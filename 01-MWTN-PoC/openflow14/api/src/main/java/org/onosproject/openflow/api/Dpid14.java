 ...
 */
public final class Dpid14 {

    private static final String SCHEME = "of14";
     ...
     * @return dpid
     */
    public static Dpid14 dpid(URI uri) {
        checkArgument(uri.getScheme().equals(SCHEME), "Unsupported URI scheme");
        return new Dpid14(fromHex(uri.getSchemeSpecificPart()));
    }
     ...
     * @return device URI
     */
    public static URI uri(Dpid14 dpid) {
