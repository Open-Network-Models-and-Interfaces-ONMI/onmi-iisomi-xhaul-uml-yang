 ...
 */
package com.highstreet.technologies.odl.app.cli.commands;
...
public class ClosedLoopAutomationCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ClosedLoopAutomationCliTestCommand.class);
    protected final ClosedLoopAutomationCliCommands service;

    public ClosedLoopAutomationCliTestCommand(final ClosedLoopAutomationCliCommands service) {
