...
public class NotificationDelayService implements AutoCloseable {
    ...
    public NotificationDelayFilter<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.ProblemNotification> getInstance12(
            String nodeName,
        ...
        NotificationDelayFilter<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.ProblemNotification> filter = this.filters12
                .getOrDefault(nodeName, null);
    ...
    public NotificationDelayFilter<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.ProblemNotification> getInstance1211(
            String nodeName,
        ...
        NotificationDelayFilter<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.ProblemNotification> filter = this.filters1211
                .getOrDefault(nodeName, null);
        LOG.trace("nodeName={}, filter!=null? {}", nodeName, filter != null);
        if (filter == null) {
            filter = new NotificationDelayFilter<>(nodeName, eventListener);
    ...
    public NotificationDelayFilter<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.ProblemNotification> getInstance1211p(
            String nodeName,
        ...
        NotificationDelayFilter<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.ProblemNotification> filter = this.filters1211p
                .getOrDefault(nodeName, null);
        LOG.trace("nodeName={}, filter!=null? {}", nodeName, filter != null);
        if (filter == null) {
            filter = new NotificationDelayFilter<>(nodeName, eventListener);
    ...
    public void close() throws Exception {
        ...
        // close all filters
        for (NotificationDelayFilter<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev170324.ProblemNotification> filter : this.filters12
                .values()) {
            filter.close();
        }

        for (NotificationDelayFilter<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev180907.ProblemNotification> filter : this.filters1211
                .values()) {
            filter.close();
        }

        for (NotificationDelayFilter<org.opendaylight.yang.gen.v1.urn.onf.params.xml.ns.yang.microwave.model.rev181010.ProblemNotification> filter : this.filters1211p
                .values()) {
            filter.close();
        }
    }
