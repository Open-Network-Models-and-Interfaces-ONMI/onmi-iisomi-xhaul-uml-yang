 ...
 */
package org.opendaylight.apigateway.cli.commands;
...
public class ApigatewayCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ApigatewayCliTestCommand.class);
    protected final ApigatewayCliCommands service;

    public ApigatewayCliTestCommand(final ApigatewayCliCommands service) {
