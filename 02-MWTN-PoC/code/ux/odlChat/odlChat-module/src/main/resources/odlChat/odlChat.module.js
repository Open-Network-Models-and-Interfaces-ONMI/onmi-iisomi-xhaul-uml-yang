/*
 * Copyright (c) 2016 higshtreet technologies GmbH, Inc. and others.  All rights reserved.
 *
...
define([ 'angularAMD', 'app/routingConfig', 'app/core/core.services',
  ...
  var odlChatApp = angular.module('app.odlChat', [ 'app.core',
      'ui.router.state', 'config' ]);

  odlChatApp.config(function($stateProvider, $compileProvider,
    ...
    NavHelperProvider.addToMenu('odlChat', {
      ...
      "active" : "main.odlChat",
      "title" : "Chat",
      "icon" : "icon-twitter", // Add navigation icon css class here
      "page" : {
        "title" : "Chat",
        "description" : "odlChat"
      }
