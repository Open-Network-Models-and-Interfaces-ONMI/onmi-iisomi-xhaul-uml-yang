...
define(modules, function(ng) {
  ...
  var mwtnCompareApp = angular.module('app.mwtnCompare', ['app.core', 'ui.router.state','config', 'app.common.yangUtils', 'ui.bootstrap', 'restangular', 'pascalprecht.translate', 'ngSlider']);
  ...
  mwtnCompareApp.config(function($stateProvider, $compileProvider, $controllerProvider, $provide, NavHelperProvider, $translateProvider) {
    ...
    NavHelperProvider.addToMenu('mwtnCompare', {
     ...
     "title" : "MWTN Compare",
     "icon" : "icon-tags",  // Add navigation icon css class here
     "page" : {
        "title" : "MWTN Compare",
