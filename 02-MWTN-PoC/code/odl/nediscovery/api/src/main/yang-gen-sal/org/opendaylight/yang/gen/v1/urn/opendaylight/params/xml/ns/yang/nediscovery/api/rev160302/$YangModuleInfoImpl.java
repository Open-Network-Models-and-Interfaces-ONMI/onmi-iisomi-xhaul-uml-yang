...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "nediscovery-api";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:nediscovery:api";
    private final String revision = "2016-03-02";
    private final String resourcePath = "/META-INF/yang/nediscovery-api.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.networkelement.api.rev160203.$YangModuleInfoImpl.getInstance());
