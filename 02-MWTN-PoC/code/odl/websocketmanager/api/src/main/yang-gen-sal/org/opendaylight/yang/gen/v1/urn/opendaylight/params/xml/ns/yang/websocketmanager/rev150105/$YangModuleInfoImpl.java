...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "websocketmanager";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:websocketmanager";
    private final String revision = "2015-01-05";
    private final String resourcePath = "/META-INF/yang/websocketmanager.yang";
