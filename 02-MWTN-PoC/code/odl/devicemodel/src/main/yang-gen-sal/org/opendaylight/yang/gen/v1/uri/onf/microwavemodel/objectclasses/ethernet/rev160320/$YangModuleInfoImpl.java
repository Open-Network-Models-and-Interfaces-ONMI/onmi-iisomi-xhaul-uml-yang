...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "MicrowaveModel-ObjectClasses-Ethernet";
    private final String namespace = "uri:onf:MicrowaveModel-ObjectClasses-Ethernet";
    private final String revision = "2016-03-20";
    private final String resourcePath = "/META-INF/yang/MicrowaveModel-ObjectClasses-Ethernet.yang";
