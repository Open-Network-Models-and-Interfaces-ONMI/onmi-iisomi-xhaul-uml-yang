...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList} instances.
 *
 * @see org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList
 *
 */
public class LocalIdListBuilder implements Builder <org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList> {

    private java.lang.String _value;
    private java.lang.String _valueName;

    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList>>, Augmentation<org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList>> augmentation = Collections.emptyMap();
    ...
    public LocalIdListBuilder(LocalIdList base) {
        ...
        if (base instanceof LocalIdListImpl) {
            ...
            AugmentationHolder<org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public LocalIdListBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class LocalIdListImpl implements LocalIdList {
        ...
        public java.lang.Class<org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList.class;
        }
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList other = (org.opendaylight.yang.gen.v1.uri.onf.coremodel.corefoundationmodule.superclassesandcommonpackages.rev160305.localclass.LocalIdList)obj;
            if (_value == null) {
