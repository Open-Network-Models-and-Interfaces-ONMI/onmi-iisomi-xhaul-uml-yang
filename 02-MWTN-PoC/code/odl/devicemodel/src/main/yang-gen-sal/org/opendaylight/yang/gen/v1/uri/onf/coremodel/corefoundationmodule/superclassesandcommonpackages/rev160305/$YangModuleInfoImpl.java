...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "CoreModel-CoreFoundationModule-SuperClassesAndCommonPackages";
    private final String namespace = "uri:onf:CoreModel-CoreFoundationModule-SuperClassesAndCommonPackages";
    private final String revision = "2016-03-05";
    private final String resourcePath = "/META-INF/yang/CoreModel-CoreFoundationModule-SuperClassesAndCommonPackages.yang";
