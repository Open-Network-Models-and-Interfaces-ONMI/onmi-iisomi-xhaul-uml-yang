...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "CoreModel-CoreNetworkModule-TypeDefinitions";
    private final String namespace = "uri:onf:CoreModel-CoreNetworkModule-TypeDefinitions";
    private final String revision = "2016-03-05";
    private final String resourcePath = "/META-INF/yang/CoreModel-CoreNetworkModule-TypeDefinitions.yang";
