...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "NetworkElement";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:networkelement:api";
    private final String revision = "2016-02-03";
    private final String resourcePath = "/META-INF/yang/NetworkElement.yang";
