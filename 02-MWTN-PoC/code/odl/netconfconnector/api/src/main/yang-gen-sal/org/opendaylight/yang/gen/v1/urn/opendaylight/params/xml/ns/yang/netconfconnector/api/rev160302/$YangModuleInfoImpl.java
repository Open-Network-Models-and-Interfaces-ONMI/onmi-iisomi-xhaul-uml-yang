...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "netconfconnector-api";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:netconfconnector:api";
    private final String revision = "2016-03-02";
    private final String resourcePath = "/META-INF/yang/netconfconnector-api.yang";
