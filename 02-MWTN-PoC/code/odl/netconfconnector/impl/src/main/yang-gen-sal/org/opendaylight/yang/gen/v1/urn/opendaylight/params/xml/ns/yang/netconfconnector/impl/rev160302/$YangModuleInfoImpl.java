...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "netconfconnector-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:netconfconnector:impl";
    private final String revision = "2016-03-02";
    private final String resourcePath = "/META-INF/yang/netconfconnector-impl.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.eventmanager.api.rev160302.$YangModuleInfoImpl.getInstance());
