...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "eventmanager-api";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:eventmanager:api";
    private final String revision = "2016-03-02";
    private final String resourcePath = "/META-INF/yang/eventmanager-api.yang";
