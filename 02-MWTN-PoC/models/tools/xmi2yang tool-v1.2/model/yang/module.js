...
function Module(name, namespace, imp, pref, org, contact, revis, descrp) {
  if (!revis) {
    revis = [new Date().toISOString().substring(0,10) + ' {', '\tdescription', '\t\t"generated by xmi2yang";', '}'].join('\r\n\t');
  }
  if (!org) {
    org = ["\n\t\t\"Open Networking Foundation", "2275 E. Bayshore Road, Suite 103, Palo Alto, CA 94303", "www.opennetworking.org\""].join('\r\n\t\t ');
  }
    this.name = name;
